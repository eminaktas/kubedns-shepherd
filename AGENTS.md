# kubedns-shepherd - AI Agent Guide
...
Generate a controller that deploys and manages a container image (nginx, redis, kubedns-shepherd, your app, etc.):

```bash
# Example: deploying kubedns-shepherd
kubebuilder create api --group example.com --version v1alpha1 --kind DNSClass \
  --image=kubedns-shepherd:alpine \
